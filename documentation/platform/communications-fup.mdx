...
| `src/inngest/functions/resend-email/email-send-resend.ts` | `backoffice-inngest-functions` | Job `emails-resend-send` — envia emails via Resend, throttle 1/s, concorrência 2; evento ouvido: `emails/resend.send` |
