...
<Warning>
  Reabrir um pulso respondido apaga todas as respostas. Use apenas em casos de erro crítico.
</Warning>
...
<Warning>
  Avaliações de lideranças são confidenciais por design. Não exponha esses dados diretamente para talentos.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Guia de Operações" icon="wrench" href="/guides/backoffice/pulsos-operacoes">
    Operações manuais
  </Card>
</CardGroup>
